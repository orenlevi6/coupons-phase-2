...
//                .company(company1.getCompanyDetails())
        ...
        TablePrinter.print(company1.getAllCompanyCoupons(Categories.FOOD));

        System.out.println("Print all company coupons by max price - 40");
        TablePrinter.print(company1.getAllCompanyCoupons(40));
...
//                .company(company2.getCompanyDetails())
        ...
        System.out.println("Print all company coupons by category - FOOD");
        TablePrinter.print(company2.getAllCompanyCoupons(Categories.FOOD));

        System.out.println("Print all company coupons by max price - 40");
        TablePrinter.print(company2.getAllCompanyCoupons(40));
